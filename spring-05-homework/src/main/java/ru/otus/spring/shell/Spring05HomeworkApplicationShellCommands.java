...
@ShellComponent
public class Spring05HomeworkApplicationShellCommands {
    ...
    public Spring05HomeworkApplicationShellCommands(BookService bookService, AuthorService authorService, GenreService genreService, LibraryView libraryView) {
